...
namespace Prian_Ilaria_Lab2.Models
{
    public class BookCategoriesPageModel : PageModel
    {
        public List<AssignedCategoryData> AssignedCategoryDataList;
        public void PopulateAssignedCategoryData(Prian_Ilaria_Lab2Context context,
        Book book)
        {
        ...
        public void UpdateBookCategories(Prian_Ilaria_Lab2Context context,
